...
class B99TrafficGenerator:
    ...
    def add_dns_traffic(self):
        ...
        flag_encoded = base64.b64encode(b"SKYDAYS{DAVUTPASA_NINE_NINE}").decode()
        response = (
    ...
    def add_http_traffic(self):
        ...
        post_data = "case_id=9901&evidence_type=document&secret_note=U0tZREFZU3tQQUNLRVRfQU5BTFlTSVNfVElUTEVfT0ZfWU9VUl9TRVhfVEFQRX0K&officer=jake"
    ...
    def add_icmp_traffic(self):
        ...
        secret_message = "U0tZREFZU3tZVFVfV0lGSV9WSU5ESUNBVElPTn0K"  # base64
        ping = (
            IP(
                src=self.characters["jake.precinct99.local"],
    ...
    def add_ftp_traffic(self):
        ...
        pass_cmd = (
            ...
            / Raw(load=b"PASS SKYDAYS{ALGORITMA_COMPLEXITY_O_NINE_NINE}\r\n")
        )  # Flag part 4
